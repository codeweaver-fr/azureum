...
La référence anatomique secondaire est une photographie dorsale de _Magicicada cassinii_. Elle permet de contrôler que le symbole reste identifiable comme une cigale, mais ne peut justifier aucune modification de la référence visuelle verrouillée :

- [_Magicicada cassinii_ femelle, vue dorsale — Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Magicicada_cassinii-female_dorsal.jpg).
